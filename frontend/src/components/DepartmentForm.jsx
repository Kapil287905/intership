...
const DepartmentFormPage = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      axios.get(`https://intership.pythonanywhere.com/api/departments/${id}/`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {        
        // Edit mode
        await axios.put(`https://intership.pythonanywhere.com/api/departments/${id}/`, {
          dept_name,
          description,
          status
        }, config);
        ...
        // Create mode
        await axios.post(`https://intership.pythonanywhere.com/api/departments/`, {
          dept_name,
          description,
          status
        }, config);
